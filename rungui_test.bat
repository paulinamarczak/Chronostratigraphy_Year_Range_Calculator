...
set "PATH= %PATH%, %ProgramFiles%\ArcGIS\Pro\bin\Python\Scripts\%, C:\Users\PMARCZAK\AppData\Roaming\Python\Python39\Scripts, C:\Users\PMARCZAK\AppData\Local\ESRI\conda\envs\arcgispro-py3-clone\Lib"
echo %PATH%
